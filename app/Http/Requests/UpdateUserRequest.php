...
class UpdateUserRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'path_img_banner' => 'nullable|string|max:500',
            'path_img_avatar' => 'nullable|string|max:500',
            'chat_wallpaper_desktop' => 'nullable|string|max:500',
            'chat_wallpaper_mobile' => 'nullable|string|max:500',
            'welcome_titulo' => 'nullable|string|max:200',
            'welcome_body' => 'nullable|string|max:5000',
            'welcome_image_url' => 'nullable|string|max:500',
            'welcome_video_url' => 'nullable|string|max:500',
            'welcome_audio_url' => 'nullable|string|max:500',
            'welcome_audio_duration' => 'nullable|integer|min:1|max:60',
